...
class TrainingUtils:
    ...
    def plot_layer_arch(self, model, stage_no):
        ...
        modelpath= self.path_dict['model_path']+"stage{}/".format(stage_no)+'{}_model_architecture_stage_{}.json'.format(self.input_params["model_name"],stage_no)
    ...
    def callbacks_list(self, stage_no):
        ...
        for j in range(num_monitored):
            ...
            checkpoint = ModelCheckpoint(filepath,
                                         ...
                                         mode=self.input_params['monitor'][j][1],
                                         period=1)
            
            checkpoint_savelist.append(checkpoint)
        ...
        list_ = checkpoint_savelist + [reduce_learning_rate, history, early_stop, tensorboard]
        return list_
    ...
    def train_stage1(self):
        ...
        #Adding a global spatial average pooling layer
            ...
            output_layer = Dense(n, activation=self.input_params['outputlayer_activation'], kernel_initializer='glorot_uniform')(x)
    ...
    def train_stage2(self):
        ...
        history=model_stg2.fit_generator(generator=self.stage1_params['train_generator'],
                                         ...
                                         callbacks=TrainingUtils.callbacks_list(self, 2),workers= self.input_params['nworkers'], use_multiprocessing=False,max_queue_size=20)
