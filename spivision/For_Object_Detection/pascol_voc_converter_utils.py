...
def convert_csv_2_pascol_voc_xml(csv_path, image_path, xml_folder,labelname='label'):
    """
    ...
    4. labelname: name used for the label in the csv
    Returns:
    ...
    for imgs in tqdm(path_list):
        ...
        for i, rows in temp_data.iterrows():
            ...
            ET.SubElement(obj, "name").text = str(rows[labelname])
        ...
        tree.write(xml_folder+"/"+imgs[0:-4]+".xml")
